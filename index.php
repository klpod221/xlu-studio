<?php
header("refresh: 5; http://xlu.epizy.com/public/");

	echo '<title>Laravel 8 Installed</title><div style="background: #e9ffed; border: 1px solid #b0dab7; padding: 15px;" align="center" >
	<font size="5" color="#182e7a">Laravel 8 is installed successfully.</font><br /><br />
	<font size="4">Laravel 8 is a Framework and doesn\'t have an index page.<br /><br />
