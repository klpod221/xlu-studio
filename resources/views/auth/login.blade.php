    ...
    <div class="auth-page">
        <form action="{{ route('auth.authenticate') }}" method="POST" class="form login">
            ...
            <div class="form__field {{ $errors->has('email') ? 'has-error' : '' }}">
                ...
                <input autocomplete="email" id="login__email" type="text" name="email" value="{{ old('email') }}" class="form__input" placeholder="Username">
            </div>
            <div class="form__field {{ $errors->has('password') ? ' has-error' : '' }}">
                ...
                <input autocomplete="current-password" id="login__password" type="password" name="password"
